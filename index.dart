...
void main () { 
  ...
  DateTime? dateConverted =_convertTuDateTime(birthdayInput!);
   if (dateConverted == null) {
    print("la fecha de nacimiento es inválida, nos esviaste: $birthdayInput");
    return;
   }
...
DateTime? _convertTuDateTime(String date) {
